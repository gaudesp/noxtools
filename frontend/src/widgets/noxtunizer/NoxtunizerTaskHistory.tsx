...
type NoxtunizerJobsStore = ReturnType<typeof useNoxtunizerJobs>

interface Props {
  store: NoxtunizerJobsStore
  onSelectJob: () => void
}

export default function NoxtunizerTaskHistory({ store, onSelectJob }: Props) {
