...
type NoxtubizerJobsStore = ReturnType<typeof useNoxtubizerJobs>

interface Props {
  store: NoxtubizerJobsStore
  onSelectJob: () => void
}

export default function NoxtubizerTaskHistory({ store, onSelectJob }: Props) {
